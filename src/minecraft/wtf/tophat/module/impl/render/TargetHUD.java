...
public class TargetHUD extends Module {
    ...
    public void on2D(Render2DEvent event) {
        ...
        int red = colors.red.get().intValue();
        int green = colors.green.get().intValue();
        int blue = colors.blue.get().intValue();
            ...
            if (health > 0.1) {
                ...
                switch (mode.get()) {
                    case "GameSense":
                        ...
                        DrawingUtil.rectangle(x - 1, y + 5, width + 1, 1, true, new Color(red,green,blue));
                        ...
                        DrawingUtil.rectangle(x + 2, y + 38, 95, 6, false, new Color(red,green,blue));
