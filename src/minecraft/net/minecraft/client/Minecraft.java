...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void startGame() throws LWJGLException, IOException
    {
        ...
        this.fontRenderer = new FontRenderer(this.settings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);
        ...
        {
            this.displayGuiScreen(new GuiConnecting(new UIMainMenuScreen(), this, this.serverName, this.serverPort));
        }
        else
        {
            this.displayGuiScreen(new UIMainMenuScreen());
        }
    ...
    public void createDisplay(String title) throws LWJGLException
    {
    ...
    public void displayGuiScreen(GuiScreen guiScreenIn)
    {
        ...
        {
            guiScreenIn = new UIMainMenuScreen();
        }
        ...
        if (guiScreenIn instanceof UIMainMenuScreen)
        {
    ...
    public void dispatchKeypresses()
    {
        ...
        if (i != 0 && !Keyboard.isRepeatEvent())
        {
            if (!(this.currentScreen instanceof GuiControls) || ((GuiControls)this.currentScreen).time <= getSystemTime() - 20L)
            {
                if (Keyboard.getEventKeyState())
                {
                    if (i == this.settings.keyBindFullscreen.getKeyCode())
                    {
                        this.toggleFullscreen();
                    }
