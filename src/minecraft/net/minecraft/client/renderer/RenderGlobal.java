...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
    ...
    {
        return this.entityOutlineFramebuffer != null && this.entityOutlineShader != null && this.mc.player != null && this.mc.player.isSpectator() && this.mc.settings.keyBindSpectatorOutlines.isKeyDown();
    }
    ...
    public void loadRenderers()
    {
        if (this.theWorld != null)
        {
            ...
            Blocks.leaves.setGraphicsLevel(this.mc.settings.fancyGraphics);
            Blocks.leaves2.setGraphicsLevel(this.mc.settings.fancyGraphics);
    ...
    public void renderEntities(Entity renderViewEntity, ICamera camera, float partialTicks)
    {
        ...
        else
        {
            ...
            this.renderManager.cacheActiveRenderInfo(this.theWorld, this.mc.fontRenderer, this.mc.getRenderViewEntity(), this.mc.pointedEntity, this.mc.settings, partialTicks);
            ...
            if (this.isRenderEntityOutlines())
            {
                ...
                for (int j = 0; j < list.size(); ++j)
                {
                    ...
                    boolean flag1 = entity3.isInRangeToRender3d(d0, d1, d2) && (entity3.ignoreFrustumCheck || camera.isBoundingBoxInFrustum(entity3.getEntityBoundingBox()) || entity3.riddenByEntity == this.mc.player) && entity3 instanceof EntityPlayer;

                    if ((entity3 != this.mc.getRenderViewEntity() || this.mc.settings.thirdPersonView != 0 || flag) && flag1)
                    {
                ...
                if (!classinheritancemultimap.isEmpty())
                {
                    ...
                    while (true)
                    {
                        ...
                        while (true)
                        {
                            ...
                            flag2 = this.renderManager.shouldRender(entity2, camera, d0, d1, d2) || entity2.riddenByEntity == this.mc.player;
                            ...
                            if ((entity2 != this.mc.getRenderViewEntity() || this.mc.settings.thirdPersonView != 0 || flag3) && (entity2.posY < 0.0D || entity2.posY >= 256.0D || this.theWorld.isBlockLoaded(new BlockPos(entity2))))
                            {
                                ++this.countEntitiesRendered;
    ...
    public void renderClouds(float partialTicks, int pass)
    {
        ...
        {
            if (this.mc.settings.shouldRenderClouds() == 2)
            {
