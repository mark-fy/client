    ...
    public void func_152922_k()
    {
        if (this.broadcastController.isBroadcasting() && !this.broadcastController.isBroadcastPaused())
        {
            ...
            if (flag)
            {
                ...
                GlStateManager.ortho(0.0D, (double)this.framebuffer.width, (double)this.framebuffer.height, 0.0D, 1000.0D, 3000.0D);
                GlStateManager.matrixMode(5888);
                GlStateManager.pushMatrix();
                GlStateManager.loadIdentity();
                GlStateManager.translate(0.0F, 0.0F, -2000.0F);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
                GlStateManager.viewport(0, 0, this.framebuffer.width, this.framebuffer.height);
                GlStateManager.enableTexture2D();
                GlStateManager.disableAlpha();
                GlStateManager.disableBlend();
                float f = (float)this.framebuffer.width;
                float f1 = (float)this.framebuffer.height;
                float f2 = (float)framebuffer1.width / (float)framebuffer1.framebufferTextureWidth;
                float f3 = (float)framebuffer1.height / (float)framebuffer1.framebufferTextureHeight;
