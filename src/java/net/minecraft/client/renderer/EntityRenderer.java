...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void updateRenderer()
    {
        ...
        float f4 = (float)this.mc.settings.renderDistanceChunks / 32.0F;
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (renderViewEntity != null && this.mc.world != null) {
            final RayTraceRangeEvent rayTraceRangeEvent = new RayTraceRangeEvent(3.0f);
            rayTraceRangeEvent.call();
            ...
            Vec3 vec3 = null;
            final float n4 = 1.0f;
            final List<Entity> entitiesInAABBexcluding = this.mc.world.getEntitiesInAABBexcluding(renderViewEntity, renderViewEntity.getEntityBoundingBox().addCoord(look.xCoord * n3, look.yCoord * n3, look.zCoord * n3).expand((double)n4, (double)n4, (double)n4), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate<Entity>()
            {
            ...
            for (Object pointedEntityObj : entitiesInAABBexcluding) {
                ...
                if (pointedEntity.getName().contains("fake!")) {
                    continue;
                }
    ...
    private void renderHand(float partialTicks, int xOffset)
    {
        if (!this.debugView)
        {
            ...
            if (this.mc.settings.thirdPersonView == 0 && !flag && !this.mc.settings.hideGUI && !this.mc.playerController.isSpectator())
            {
                this.enableLightmap();
    ...
    {
        if (this.mc.settings.shouldRenderClouds() != 0)
        {
    ...
    private void addRainParticles()
    {
        ...
        if (!this.mc.settings.fancyGraphics)
        {
            f /= 2.0F;
        }
