...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (this.mc.settings.heldItemTooltips && !this.mc.playerController.isSpectator())
        {
        ...
        if (!this.mc.settings.keyBindPlayerList.isKeyDown() || this.mc.isIntegratedServerRunning() && this.mc.player.sendQueue.getPlayerInfoMap().size() <= 1 && scoreobjective1 == null)
        {
