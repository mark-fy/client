package wtf.tophat.utilities.combat.rotations;
...
public class RaytraceUtil implements Methods {
	...
	public static MovingObjectPosition rayCast(final float partialTicks) {
		...
		if (entity != null && mc.world != null) {
			...
			Vec3 vec6 = null;
			final float f = 1.0f;
			final List list = mc.world.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec4.xCoord * d0, vec4.yCoord * d0, vec4.zCoord * d0).expand(f, f, f), Predicates.and(EntitySelectors.NOT_SPECTATING));
			double d3 = d2;
