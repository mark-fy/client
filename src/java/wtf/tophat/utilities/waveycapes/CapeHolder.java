package wtf.tophat.utilities.waveycapes;
...
//        final float heightMul = (float)WaveyCapesBase.config.heightMultiplier;
		final float heightMul = 16; // read line above. uses a config height multiplier.
