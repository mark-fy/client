...
import wtf.tophat.utilities.misc.EncryptionUtil;
...
public class LoginGui extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.password = new GuiTextField(var3, this.mc.fontRenderer, width / 2 - 75, 210, 150, 20);
    ...
    private boolean checkLogin(String username, String password) {
        try {
            if (username.equals("MarkGG") && password.equals("MarkGG")) {
                return true;
            } else if (username.equals("Fyre") && password.equals("Fyre*")){
                return true;
            } else if (username.equals("Splitz") && password.equals("Splitz")){
                return true;
            }
        } catch (Exception ignored) {
        }
