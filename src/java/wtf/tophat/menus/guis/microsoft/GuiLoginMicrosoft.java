package wtf.tophat.menus.guis.microsoft;

import net.minecraft.client.gui.*;
import net.minecraft.client.resources.I18n;
import org.lwjgl.input.Keyboard;
import wtf.tophat.utilities.misc.SessionChanger;
...
public class GuiLoginMicrosoft extends GuiScreen {
    ...
    public void drawScreen(final int x2, final int y2, final float z2) {
        ...
        GuiLoginMicrosoft.drawCenteredString(this.mc.fontRenderer, "Email & Password", (int)(this.width / 2), (int)(sr.getScaledHeight() / 2 - 65), -1);
