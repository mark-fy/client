...
public class SpotifyAPI {
    ...
    public final SpotifyApi SPOTIFY = new SpotifyApi.Builder()
            .setClientId("1101e385f75b44e2831ac97134b9f2ac")
    ...
    private final SpotifyCallback callback = code -> {
        mc.player.addChatComponentMessage(new ChatComponentText(PREFIX + " Connecting..."));
        ...
        if (!authenticated) {
            try {
                ...
                try {
                    ...
                    mc.player.addChatComponentMessage(new ChatComponentText(PREFIX + " Waiting for Spotify confirmation..."));
                    callbackServer = HttpServer.create(new InetSocketAddress(8888), 0);
